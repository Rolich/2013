...
jQuery.fn.validationEngine = function(settings) {
	if($.validationEngineLanguage){					// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = {"required":{    			  // Add your regex rules here, you can take telephone as an example
						...
						"onlyWord":{
							"regex":"/^[А-ЯЁ]{1}[а-яё]+\\s{1}[А-ЯЁ]{1}[а-яё]+$/",
							"alertText":"Только русские буквы! ФИО с большой буквы через пробел"},
                        "allWord":{
							"regex":"/^[А-ЯA-Z]{1}[А-ЯA-ZЁа-яa-zё0-9\-\:\;\.\,\"\'\(\)\\s]+$/",
							"alertText":"Заглавная буква!Остальные строчные"},
                        "semiWord":{
							"regex":"/^[А-ЯЁ]{1}[а-яё]+\\s{1}[А-ЯЁ]{1}\.[А-ЯЁ]{1}\.$/",
							"alertText":"Заглавная буква!"},
                        "date":{
							"regex":"/^[0-9]{4}\-[0-9]{2}\-[0-9]{2}$/",
							"alertText":"Формат даты yyyy-mm-dd!"}
